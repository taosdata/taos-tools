...
int queryTestProcess() {
    ...
    if ((g_queryInfo.superQueryInfo.sqlCount > 0) &&
        ...
        pidsOfSub =
            benchCalloc(1, g_queryInfo.superQueryInfo.threadCnt * sizeof(pthread_t), false);
        infosOfSub = benchCalloc(
            1, g_queryInfo.superQueryInfo.threadCnt * sizeof(threadInfo), false);
